...
export function Cta() {
  return (
    <section className="pb-40">
      <div className="relative z-0 mx-auto w-full max-w-[1120px] rounded-2xl border border-white/[0.08] bg-[#080812]">
        <div className="pb-[54px] pt-15">
          <div className="relative z-0 mx-auto w-full max-w-[732px]">
            <Badge
              className="mb-3 ml-1 h-[25px] items-center gap-2 rounded bg-white/[0.04] px-1.5 text-xs tracking-[0.02em] text-white"
            ...
            >
              <div className="mx-auto w-full max-w-[595px] pt-3 text-center">
                <Badge className="mx-auto mb-5 h-[22px] text-xs tracking-[0.09em] text-white">
                  My-Finance
                </Badge>
            ...
            <p className="absolute -left-10 top-20 w-fit origin-bottom -rotate-90 text-xs tracking-[0.09em] text-[#363A4C]">
              666 x 324
            </p>
          </div>
        </div>

        <BGBoxes className="pointer-events-none absolute left-0 top-0 -z-10 w-full" />
        <Image
          src={gradient}
          alt="Gradient"
          className="pointer-events-none absolute left-1/2 top-0 -z-20 mx-auto w-full max-w-[695px] -translate-x-1/2"
        />
      </div>
    </section>
  );
